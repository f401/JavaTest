...
import net.qpowei.mcdownload.handler.VersionListResolver;
...
public class Main {
	...
	public static void main(String[] args) {
		System.out.println(JsonParser.parseVersionIndex("/storage/emulated/0/1.19.2.json").arguments.game[22]);
